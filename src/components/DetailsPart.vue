  ...
  data() {
    return {
      details: [
        ...
        {
          text: "Если вы захотите подарить нам букет, то предлагаем не мучить цветы жаркой погодой и заменить их бутылочкой любимого алкогольного напитка или полезными вещами для домашнего уюта.",
        },
        {
